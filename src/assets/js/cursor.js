...
(function (z, F) {
  typeof exports == 'object' && typeof module != 'undefined'
    ...
    ? define(F)
    : ((z = typeof globalThis != 'undefined' ? globalThis : z || self), (z['webgl-fluid'] = F()));
})(this, function () {
  'use strict';
  ...
  (function (F, _) {
    ...
    function me(e, t) {
      Object.defineProperty(e, t, {
        ...
        set: function (i) {
          this.__state.space !== 'HSV' && (E.recalculateHSV(this), (this.__state.space = 'HSV')),
            (this.__state[t] = i);
        },
      });
    }
    ...
    function I(e, t, i, r) {
      (e.style.background = ''),
        d.each(Ce, function (u) {
          e.style.cssText +=
            'background: ' + u + 'linear-gradient(' + t + ', ' + i + ' 0%, ' + r + ' 100%); ';
        });
    }
    ...
    function qe(e, t, i) {
      ...
      i.setValue = d.compose(function (c) {
        return e.getRoot().__preset_select && i.isModified() && Le(e.getRoot(), !0), c;
      }, i.setValue);
    }
    ...
    function U(e, t) {
      ...
      if (r !== -1) {
        ...
        if (
          (u === void 0 && ((u = {}), (i.__rememberedObjectIndecesToControllers[r] = u)),
          (u[t.property] = t),
    ...
    function se(e, t, i, r) {
      ...
      r.before instanceof x && (r.before = r.before.__li), U(e, u), l.addClass(u.domElement, 'c');
      ...
      return (
        ...
        u instanceof ge ? l.addClass(b, 'color') : l.addClass(b, tt(u.getValue())),
        qe(e, b, u),
    ...
    function P(e) {
      ...
      if (
        ...
        (document.getElementById('dg-save-locally').style.display = 'block'),
          localStorage.getItem(oe(e, 'isLocal')) === 'true' && b.setAttribute('checked', 'checked'),
          Ie(e, g),
      ...
      l.bind(v, 'keydown', function (S) {
        ...
        l.bind(i, 'click', function () {
          (v.innerHTML = JSON.stringify(e.getSaveObject(), void 0, 2)),
            de.show(),
            v.focus(),
            v.select();
        }),
    ...
    var ze = Array.prototype.forEach,
        ...
        },
        {
          ...
          conversions: {
            RGBA_OBJ: {
              read: function (e) {
                return (
                  !!(d.isNumber(e.r) && d.isNumber(e.g) && d.isNumber(e.b) && d.isNumber(e.a)) && {
                    space: 'RGB',
                    r: e.r,
                    g: e.g,
                    b: e.b,
            ...
            RGB_OBJ: {
              read: function (e) {
                return (
                  !!(d.isNumber(e.r) && d.isNumber(e.g) && d.isNumber(e.b)) && {
                    space: 'RGB',
                    r: e.r,
                    g: e.g,
                    b: e.b,
            ...
            HSVA_OBJ: {
              read: function (e) {
                return (
                  !!(d.isNumber(e.h) && d.isNumber(e.s) && d.isNumber(e.v) && d.isNumber(e.a)) && {
                    space: 'HSV',
                    h: e.h,
                    s: e.s,
                    v: e.v,
            ...
            HSV_OBJ: {
              read: function (e) {
                return (
                  !!(d.isNumber(e.h) && d.isNumber(e.s) && d.isNumber(e.v)) && {
                    space: 'HSV',
                    h: e.h,
                    s: e.s,
                    v: e.v,
            ...
            if (t.litmus(e))
              return (
                d.each(t.conversions, function (i, r) {
                  if (((pe = i.read(e)), we === !1 && pe !== !1))
                    return (we = pe), (pe.conversionName = r), (pe.conversion = i), d.BREAK;
                }),
                d.BREAK
              );
          }),
      ...
      ve = {
        ...
        rgb_to_hsv: function (e, t, i) {
          ...
          return u === 0
            ? { h: NaN, s: 0, v: 0 }
            : ((g = c / u),
              (h = e === u ? (t - i) / c : t === u ? 2 + (i - e) / c : 4 + (e - t) / c),
              (h /= 6) < 0 && (h += 1),
              { h: 360 * h, s: g, v: u / 255 });
        },
      ...
      E = (function () {
        function e() {
          if ((H(this, e), (this.__state = Se.apply(this, arguments)), this.__state === !1))
    ...
    (E.recalculateRGB = function (e, t, i) {
      if (e.__state.space === 'HEX') e.__state[t] = ve.component_from_hex(e.__state.hex, i);
      else {
    ...
    var Q = /(\d+(\.\d+)?)px/,
      l = {
        ...
        addClass: function (e, t) {
          if (e.className === void 0) e.className = t;
            ...
            i.indexOf(t) === -1 &&
              (i.push(t), (e.className = i.join(' ').replace(/^\s+/, '').replace(/\s+$/, '')));
          }
          return l;
        },
      ...
      le = (function (e) {
        function t(i, r) {
          H(this, t);
          var u = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)),
            c = u;
          return (
            (u.__prev = u.getValue()),
      ...
      Ne = (function (e) {
        function t(i, r, u) {
          H(this, t);
          var c = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)),
            h = u,
            g = c;
          ...
          G(t, [
            {
              ...
              value: function (i) {
                ...
                return (
                  this.__onFinishChange && this.__onFinishChange.call(this, this.getValue()), r
                );
              },
            },
            {
          ...
          return (
            ...
            d.isUndefined(c.__step)
              ? c.initialValue === 0
                ? (c.__impliedStep = 1)
                : (c.__impliedStep =
                    Math.pow(10, Math.floor(Math.log(Math.abs(c.initialValue)) / Math.LN10)) / 10)
        ...
        return (
          ...
          G(t, [
            ...
            },
            {
              ...
              value: function (i) {
                return (
                  (this.__step = i), (this.__impliedStep = i), (this.__precision = Ee(i)), this
                );
              },
            },
          ]),
        ...
        function t(i, r, u) {
          ...
          return (
            ...
            l.bind(b.__input, 'keydown', function (T) {
              T.keyCode === 13 &&
                ((v.__truncationSuspended = !0), this.blur(), (v.__truncationSuspended = !1), c());
            }),
            b.updateDisplay(),
              ...
              value: function () {
                return (
                  (this.__input.value = this.__truncationSuspended
                    ? this.getValue()
                    : ie(this.getValue(), this.__precision)),
                  K(
                    t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                    'updateDisplay',
                    this,
      ...
      ce = (function (e) {
        function t(i, r, u, c, h) {
          function g(R) {
            ...
            return m.setValue(n(R.clientX, Z.left, Z.right, m.__min, m.__max)), !1;
          }
          ...
          var T = A(
              this,
              (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r, {
                min: u,
                max: c,
                step: h,
              }),
          ...
          return (
            ...
            l.bind(T.__background, 'touchstart', function (R) {
              R.touches.length === 1 &&
                (l.bind(window, 'touchmove', v), l.bind(window, 'touchend', S), v(R));
            }),
          ...
          G(t, [
            {
              ...
              value: function () {
                ...
                return (
                  (this.__foreground.style.width = 100 * i + '%'),
                  K(
                    t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                    'updateDisplay',
                    this,
      ...
      ge = (function (e) {
        function t(i, r) {
          ...
          function b() {
            var B = Se(this.value);
            B !== !1
              ? ((R.__color.__state = B), R.setValue(R.__color.toOriginal()))
          ...
          function T(B) {
            ...
            var Y = R.__hue_field.getBoundingClientRect(),
              $ = 1 - (((B.touches && B.touches[0]) || B).clientY - Y.top) / (Y.bottom - Y.top);
            return (
              $ > 1 ? ($ = 1) : $ < 0 && ($ = 0),
              (R.__color.h = 360 * $),
              R.setValue(R.__color.toOriginal()),
          ...
          G(t, [
            {
              ...
              value: function () {
                ...
                if (i !== !1) {
                  ...
                  d.each(
                    ...
                    function (h) {
                      if (
                        !d.isUndefined(i[h]) &&
                        !d.isUndefined(this.__color.__state[h]) &&
                ...
                d.extend(this.__field_knob.style, {
                  ...
                  (this.__temp.s = 1),
                  (this.__temp.v = 1),
                  I(this.__saturation_field, 'left', '#fff', this.__temp.toHexString()),
        ...
        return d.isArray(arguments[2]) || d.isObject(arguments[2])
          ...
          ? d.isNumber(arguments[2]) && d.isNumber(arguments[3])
            ? d.isNumber(arguments[4])
              ? new ce(e, t, arguments[2], arguments[3], arguments[4])
    ...
    var M = 'Default',
      ...
      C = function e(t) {
        ...
        (this.domElement = document.createElement('div')),
          ...
          d.isUndefined(r.load) ? (r.load = { preset: M }) : r.preset && (r.load.preset = r.preset),
          d.isUndefined(r.parent) && r.hideable && W.push(this),
          (r.resizable = d.isUndefined(r.parent) && r.resizable),
          r.autoPlace && d.isUndefined(r.scrollable) && (r.scrollable = !0);
        var u = re && localStorage.getItem(oe(this, 'isLocal')) === 'true',
          c = void 0,
          h = void 0;
        if (
          (Object.defineProperties(this, {
            ...
            preset: {
              ...
              set: function (v) {
                i.parent ? (i.getRoot().preset = v) : (r.load.preset = v), $e(this), i.revert();
              },
            },
            width: {
              get: function () {
            ...
            closed: {
              ...
              set: function (v) {
                (r.closed = v),
                  ...
                  this.onResize(),
                  i.__closeButton && (i.__closeButton.innerHTML = v ? e.TEXT_OPEN : e.TEXT_CLOSED);
              },
            },
            load: {
              get: function () {
            ...
            useLocalStorage: {
              ...
              set: function (v) {
                re &&
                  ((u = v),
                  v ? l.bind(window, 'unload', c) : l.unbind(window, 'unload', c),
        ...
        r.autoPlace &&
          ...
          (c = function () {
            re &&
              ...
              localStorage.setItem(oe(i, 'gui'), JSON.stringify(i.getSaveObject()));
          }),
    ...
    (C.toggleHide = function () {
      ...
      d.extend(C.prototype, {
          ...
          if (e.scrollable) {
            ...
            d.each(e.__ul.childNodes, function (r) {
              ...
              window.innerHeight - t - 20 < i
                ...
                : (l.removeClass(e.domElement, C.CLASS_TOO_TALL), (e.__ul.style.height = 'auto'));
          }
          e.__resize_handle &&
            d.defer(function () {
        ...
        remember: function () {
          if (
            (d.isUndefined(de) &&
              ((de = new Ue()).domElement.innerHTML = `<div id="dg-save" class="dg dialogue">
      ...
      and your friends may not see the same values you do.
        ...
        saveAs: function (e) {
          this.load.remembered ||
            ((this.load.remembered = {}), (this.load.remembered[M] = Te(this, !0))),
  ...
  function z(F, _) {
    ...
    Le() && (_.DYE_RESOLUTION = 512),
      I.supportLinearFiltering ||
        ((_.DYE_RESOLUTION = 512), (_.SHADING = !1), (_.BLOOM = !1), (_.SUNRAYS = !1));
    ...
    function Pe(o, s, a, f) {
      ...
      return (
        ...
        o.framebufferTexture2D(o.FRAMEBUFFER, o.COLOR_ATTACHMENT0, o.TEXTURE_2D, p, 0),
    ...
    class qe {
      ...
      setKeywords(s) {
        ...
        f != this.activeProgram && ((this.uniforms = oe(f)), (this.activeProgram = f));
      }
    ...
    class U {
      constructor(s, a) {
        (this.uniforms = {}), (this.program = se(s, a)), (this.uniforms = oe(this.program));
      }
...
`,
      ...
      A = (() => (
        ...
        n.bufferData(n.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), n.STATIC_DRAW),
    ...
    function C() {
      ...
      E == null
        ...
        : (E = je(E, s.width, s.height, f.internalFormat, f.format, a, y)),
        x == null
          ? (x = Oe(o.width, o.height, p.internalFormat, p.format, a, y))
          : (x = je(x, o.width, o.height, p.internalFormat, p.format, a, y)),
        (Be = X(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST)),
        (Ae = X(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST)),
        (Q = Oe(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST)),
        Xe(),
        Ve();
    }
    ...
    function Xe() {
      ...
      (l = X(o.width, o.height, a.internalFormat, a.format, s, f)), (ie.length = 0);
    ...
    function X(o, s, a, f, p, w) {
      ...
      n.bindFramebuffer(n.FRAMEBUFFER, L),
        n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, y, 0),
        n.viewport(0, 0, o, s),
      ...
      return {
        ...
        texelSizeY: te,
        attach(ye) {
          return n.activeTexture(n.TEXTURE0 + ye), n.bindTexture(n.TEXTURE_2D, y), ye;
        },
      };
    }
    ...
    function Ye(o, s, a, f, p, w, y) {
      let L = X(s, a, f, p, w, y);
      return ue.bind(), n.uniform1i(ue.uniforms.uTexture, o.attach(0)), A(L.fbo), L;
    }
      ...
      return (
        (f.onload = () => {
          (a.width = f.width),
            (a.height = f.height),
            n.bindTexture(n.TEXTURE_2D, s),
            n.texImage2D(n.TEXTURE_2D, 0, n.RGB, n.RGB, n.UNSIGNED_BYTE, f);
        }),
        (f.src = o),
        a
      );
    ...
    function u() {
      const o = c();
      h() && C(), g(o), b(), _.PAUSED || v(o), S(null), requestAnimationFrame(u);
    }
    ...
    function v(o) {
      ...
      for (let a = 0; a < _.PRESSURE_ITERATIONS; a++)
        n.uniform1i(j.uniforms.uPressure, Q.read.attach(1)), A(Q.write.fbo), Q.swap();
      fe.bind(),
        ...
        I.supportLinearFiltering ||
          n.uniform2f(M.uniforms.dyeTexelSize, x.texelSizeX, x.texelSizeY);
      ...
      n.uniform1i(M.uniforms.uVelocity, s),
        ...
        I.supportLinearFiltering ||
          n.uniform2f(M.uniforms.dyeTexelSize, E.texelSizeX, E.texelSizeY),
    ...
    function S(o) {
      _.BLOOM && Z(E.read, l),
        ...
        o == null || !_.TRANSPARENT
          ? (n.blendFunc(n.ONE, n.ONE_MINUS_SRC_ALPHA), n.enable(n.BLEND))
          : n.disable(n.BLEND);
      let s = o == null ? n.drawingBufferWidth : o.width,
        a = o == null ? n.drawingBufferHeight : o.height;
      n.viewport(0, 0, s, a);
      let f = o == null ? null : o.fbo;
      _.TRANSPARENT || T(f, dt(_.BACK_COLOR)), o == null && _.TRANSPARENT && m(f), R(f, s, a);
    }
    ...
    function ot(o, s, a) {
      _.TRIGGER === 'click' && (o.moved = o.down),
        ...
        _.TRIGGER === 'hover' && (o.moved = Math.abs(o.deltaX) > 0 || Math.abs(o.deltaY) > 0);
    }
